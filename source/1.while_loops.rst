...
.. raw:: html
   ...
   <div id="maxPoints" data-max-points="20"></div>
...
.. raw:: html
   ...
   <div class="mcq">
      ...
      [   
      { "ansid":"Q1A1", "answer": "2", "feedback": "Incorrect. Remember, the loop increments by 2 starting from 3 and checks the condition before each iteration.", "result": "" , "points": 0} ,  
      { "ansid":"Q1A2", "answer": "3", "feedback": "Correct! The loop starts at 3, increments by 2 each time, and stops before reaching 8.", "result": "correct", "points": 5  } ,  
      { "ansid":"Q1A3", "answer": "4", "feedback": "Incorrect. Calculate how many iterations occur with the loop starting at 3 and increasing by 2 until it's less than 8.", "result": "" , "points": 0} ,  
...
.. raw:: html
   ...
   <div class="mcq">
      <p>Given the Python code that calculates the cumulative sum of integers until the sum exceeds 100, what is the final value of <code>i</code> when the sum first exceeds 100? (5 pts)</p>
      ...
      [
         {"ansid":"Q2A1", "answer":"14", "feedback": "Correct! The loop adds up to 105 when i is 14 and then breaks.", "result": "correct" , "points": 5},
         {"ansid":"Q2A2", "answer":"15", "feedback": "Incorrect. The loop already broke when i was 14.", "result": "" , "points": 0},
         {"ansid":"Q2A3", "answer":"16", "feedback": "Incorrect. The sum exceeds 100 before this point.", "result": "" , "points": 0},
         {"ansid":"Q2A4", "answer":"17", "feedback": "Incorrect. The sum exceeds 100 before this point.", "result": "" , "points": 0}
      ]
      </script>
   </div>
...
.. raw:: html
   ...
   <div class="mcq">
   <p>True or False: A <code>while</code> loop in Python will always execute at least once before checking its condition. (10 pts)</p>
   ...
   [
      ...
      {"ansid":"Q3A2", "answer":"False", "feedback": "Correct! A while loop in Python checks its condition before executing the loop body for the first time.", "result": "correct" , "points": 10}
   ]
   </script>
   </div>
